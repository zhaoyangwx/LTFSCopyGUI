...
#End Region
    ...
    Public Function AnalyzeAndRemoveWavHeader(ByVal data As Byte(),
        ...
        If Encoding.ASCII.GetString(data, 0, 4) = "RIFF" AndAlso Encoding.ASCII.GetString(data, 8, 4) = "WAVE" Then
            ...
            channels = value
            Dim subTruncSize As Integer = BitConverter.ToInt32(data, 16)
            ...
            isFloat = value
            ' 拷贝纯 PCM 数据
            Dim pcmLength As Integer = data.Length - 28 - subTruncSize
            Dim pcmData(pcmLength - 1) As Byte
            Buffer.BlockCopy(data, 28 + subTruncSize, pcmData, 0, pcmLength)
