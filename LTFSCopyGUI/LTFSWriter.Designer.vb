...
Partial Class LTFSWriter
    ...
    Private Sub InitializeComponent()
        ...
        Me.TestToolStripMenuItem.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() {Me.停止等待缓存ToolStripMenuItem, Me.选中二级目录ToolStripMenuItem, Me.导出待写列表ToolStripMenuItem, Me.监控写入ToolStripMenuItem, Me.自适应限速ToolStripMenuItem, Me.从文件添加ToolStripMenuItem, Me.提取为空文件ToolStripMenuItem, Me.按索引删除硬盘文件ToolStripMenuItem})
    ...
    Friend WithEvents 去重ToolStripMenuItem As ToolStripMenuItem
