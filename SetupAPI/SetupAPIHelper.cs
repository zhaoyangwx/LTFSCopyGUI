...
namespace SetupAPIHelper
{
    ...
    public class Device : IDisposable
    {
        ...
        public string InstanceId { get; set; }   // Unique identifier of the device
        public string Manufacturer { get; set; }
        public string Name { get; set; }
        public string PDOName { get; set; }
        public bool Present { get; set; }
        public DeviceErrorCode ProblemCode { get; set; }
        public DeviceStatus Status { get; set; }

        private SafeDeviceInfoSet devInfoSet { get; set; }
        private NativeHelpers.SP_DEVINFO_DATA devInfoData { get; set; }
        ...
        internal Device(SafeDeviceInfoSet devInfoSet, NativeHelpers.SP_DEVINFO_DATA devInfoData)
        {
            ...
            Present = (bool)GetProperty("DEVPKEY_Device_IsPresent", defaultValue: true);
            UpdateStatus();
        }
        ...
        public static IEnumerable<Device> EnumerateDevices(Guid classGuid, string enumerator)
        {
            return EnumerateDevices(classGuid, enumerator, NativeHelpers.GetClassFlags.DIGCF_ALLCLASSES, null);
        }
